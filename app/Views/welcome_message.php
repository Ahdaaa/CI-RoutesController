...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Latihan Routing dan Controller CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>

        <h2>Framework kecil dengan banyak fitur!</h2>
